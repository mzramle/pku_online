...
import 'package:pku_online/data/extension.dart';
import 'package:pku_online/core/light_color.dart';
  ...
  Widget _header() {
    return Column(
      ...
      children: <Widget>[
        ...
        Text("Azzam MAP", style: TextStyles.h1Style),
      ],
    ).p16;
  }
    ...
    return Container(
      ...
      child: TextField(
        decoration: InputDecoration(
          ...
          suffixIcon: SizedBox(
              width: 50,
              child: Icon(Icons.search, color: Color(0xff59011c))
                  .alignCenter
        ...
        Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Text(
                "See All",
                style: TextStyles.titleNormal.copyWith(color: grayText),
              ).p(8).ripple(() {})
            ],
          ),
        ),
